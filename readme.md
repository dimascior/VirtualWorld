...
![Live render](render_engine_v2/render_screenshot.svg)

**ASCII buffer from live keystroke session:**

```
_---[[)(|/tf]]]][{1vvvvczX|nxxrrjft/}[[[fft/())[-??-_]?{1111
___++__}(||||{?]][[}xxxxxn))()1}|rrrrft?????}([[[[[+]{111rrY
+_+]]{11)[---[}-1))111)|/x|[[}}}jfttt1?--??})111[__+~~|XYYYY
v((?--?1[111]__--()(|/]]??]ttt/1]??-|{}[]_[}[{{]__||XXXXYYYY
cvvuu//{1{-~+_[1{1[---_[}{{}}}{}[[}[][)[_++]1}}tczzXXXXXYYYY
vvvuunnfjjjjrnunnvzzzz/nxrrfft/rxj((()//]~~)(vvcczzXXXXXXYYY
vvuuunnfjjjjrnunnvzXzzYUUYYJJYXYYzvvvnrxxftnuvvcczzzzXXXXXXX
vvuunnntjjfjrnnnnuz?//tUUYYUJYXtf/vvvnrxrftxuuvvcczzzzzzXXXX
vuunnnxtjjffrxnnnuc---?cccccccc??-uvvjttf[txnuuvccccczzzzzzz
uunnxxxtffffjxxxxnv-__-cccccccc-?-nuuf//t[/xnnuuvvcccccczzzz
unnxxxr/ffttfrxrrxu____cccccccc_-_xnnjttf)/rxnnnuvvvvvvccccc
nnxxrrr/tt//fjrjjrn+++_cccccccc__+[[[]?]]--]rxxnnuuuuuvvvvcc
x-_____~+j~/tfjffjr+~~+uunnuuun++~llIIIII;;;jrrxxnnnuuuuuvvv
/nnnnnnnnn`|/tfttfj{((|rrjjrxjf|ZZII{//|()U(xrjrrxxnnnnnuuuu
{nnnnnnnn-`:;;:_|tffttfjjttjjft]88;vJYUYXczzcucuurrxxxxnnnnu
:::""";;;;;:+/,|||tt/|tft//tf]];;I;IfY0LCCLCJUYYYYXunnrxxxnn
;;;;;;;::I~><!,<__-iiii????>>>>,:::":}fz000QLCCCCJJYXXXXcvxx
~~^^"^,,illl>;,+~-++??<>>>>]]]?llll>::I[xUZO0LLLLLLLCUYYYYYX
~;,,;^,,>+-~i>>>+??]]_<<<<________++]:::}xxYO00000QQCCJUUJJj
;;!li^,,?+++++>_<<<<_]][[[<<<<<<]][[[]:::l}jjjjjrxn]?-_++_-?
```
...
required. Each image is a direct pixel-accurate export of the ray tracer output
at the listed camera pose.

| View | Description |
|------|-------------|
| ![Default starting view](render_engine_v2/screenshots/00_default.svg) | **Default starting view** `yaw +0 pitch +0 pos (0.0, 1.6, 0.5)` |
| ![Close-up of the bed](render_engine_v2/screenshots/01_bed_closeup.svg) | **Close-up of the bed** `yaw -35 pitch +12 pos (1.2, 1.6, 1.5)` |
| ![Desk and window area](render_engine_v2/screenshots/02_desk_window.svg) | **Desk and window area** `yaw +45 pitch +0 pos (-1.5, 1.6, 1.2)` |
| ![From the doorway looking into the room](render_engine_v2/screenshots/03_doorway_looking_in.svg) | **From the doorway looking into the room** `yaw +180 pitch +5 pos (0.0, 1.6, 3.2)` |
| ![Looking up at the ceiling](render_engine_v2/screenshots/04_ceiling_glance.svg) | **Looking up at the ceiling** `yaw +0 pitch -55 pos (0.0, 1.6, 1.5)` |
| ![Low-angle corner shot](render_engine_v2/screenshots/05_floor_corner.svg) | **Low-angle corner shot** `yaw +30 pitch +35 pos (-1.8, 1.4, 0.3)` |
| ![Wide sweep - side wall](render_engine_v2/screenshots/06_wide_sweep.svg) | **Wide sweep - side wall** `yaw -90 pitch +0 pos (0.0, 1.8, 1.5)` |
...
| View | Description |
|------|-------------|
| ![Bedroom -- standing at the entrance](render_engine_v2/screenshots/env_00_bedroom_entrance.svg) | **Entrance** `yaw +0 pitch +0 pos (0.0, 1.6, 0.5)` |
| ![Bedroom -- looking across the bed](render_engine_v2/screenshots/env_01_bedroom_bed.svg) | **Across the bed** `yaw -25 pitch +10 pos (1.0, 1.6, 2.5)` |

### Office

| View | Description |
|------|-------------|
| ![Office -- open floor view](render_engine_v2/screenshots/env_02_office_floor.svg) | **Open floor** `yaw +0 pitch +0 pos (0.0, 1.6, 0.0)` |
| ![Office -- cubicle corner angle](render_engine_v2/screenshots/env_03_office_corner.svg) | **Cubicle corner** `yaw +35 pitch +5 pos (-1.5, 1.6, 2.0)` |

### Corridor

| View | Description |
|------|-------------|
| ![Corridor -- centre of the sci-fi hallway](render_engine_v2/screenshots/env_04_corridor_centre.svg) | **Hallway centre** `yaw +0 pitch +0 pos (0.0, 1.6, 0.0)` |
| ![Corridor -- glowing panel close-up](render_engine_v2/screenshots/env_05_corridor_glow.svg) | **Glowing panel** `yaw -20 pitch -5 pos (0.8, 1.2, 2.0)` |

### Park

| View | Description |
|------|-------------|
| ![Park -- open-air overview](render_engine_v2/screenshots/env_06_park_overview.svg) | **Open-air overview** `yaw +0 pitch +0 pos (0.0, 1.6, 0.0)` |
| ![Park -- water and pond edge](render_engine_v2/screenshots/env_07_park_pond.svg) | **Pond edge** `yaw -45 pitch +12 pos (2.0, 1.6, 3.0)` |

### Dungeon

| View | Description |
|------|-------------|
| ![Dungeon -- torchlit entry corridor](render_engine_v2/screenshots/env_08_dungeon_entry.svg) | **Torchlit entry** `yaw +0 pitch +0 pos (0.0, 1.6, 0.5)` |
| ![Dungeon -- torch flame from below](render_engine_v2/screenshots/env_09_dungeon_torch.svg) | **Torch from below** `yaw +15 pitch -8 pos (-0.8, 1.6, 1.8)` |

### Abstract

| View | Description |
|------|-------------|
| ![Abstract -- floating shapes, centre void](render_engine_v2/screenshots/env_10_abstract_centre.svg) | **Centre void** `yaw +0 pitch +0 pos (0.0, 1.6, 0.0)` |
| ![Abstract -- low angle, looking up through shapes](render_engine_v2/screenshots/env_11_abstract_low.svg) | **Low angle** `yaw +45 pitch -20 pos (0.0, 0.5, 0.0)` |
